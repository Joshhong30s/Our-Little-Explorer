      ...
      <div className='flex flex-col md:flex-row min-h-screen'>
        <div className='md:w-1/3 flex flex-col md:pr-4'>
          <div className='flex-1 h-1/2 bg-yellow-200 p-4 rounded-md mb-4 flex flex-col justify-center items-center'>
            ...
            <div className='flex-1 flex gap-4 p-4 rounded-md'>
              <div className='card bg-white shadow-md rounded p-4 w-1/3 flex-1 flex-col justify-center items-center space-y-2'>
